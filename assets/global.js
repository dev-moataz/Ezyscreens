...
class SlideshowComponent extends SliderComponent {
  constructor() {
    ...
    this.visbleSlidesDesktop = this.slider.dataset.desktop;
  ...
  onButtonClick(event) {
    ...
    let isLastSlide = this.currentPage === this.sliderItemsToShow.length;

    if (window.innerWidth > 768 && this.visbleSlidesDesktop) {
      isLastSlide = this.currentPage === ( this.sliderItemsToShow.length - Number( this.visbleSlidesDesktop) -1 ); 
    }
